...
<html>
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div style="position: absolute; padding-top: 45%; padding-left: 6%; text-align: center;"class="accordion" id="accordion2">
          <div class="accordion-group">
            ...
            <div id="collapseOne" class="accordion-body collapse">
              <div class="accordion-inner">
                	<iframe frameBorder="0" src="/Testing/phpframeworks/CodeIgniter_2/index.php/game/leaderboard"></iframe>
              </div>
            </div>
          </div>
      </div>
